...
- HARD RULE: SUBJECT-CARD ALIGNMENT. The priority card MUST match what the answer actually leads with. If the answer leads with agent-first / serving lens content → priority is wiki/agent-first or belief.agent-first. If it leads with voice-AI-at-scale evidence → priority is lab/voice-ai-production. If it leads with second-brain / personal knowledge graph → priority is lab/second-brain or wiki/second-brain. If it leads with spec discipline / taste → priority is wiki/spec-first-taste. The reader should be able to click priority and find the page that elaborates the spine sentence of your answer.
- AVOID lazy defaults. Do NOT make resume the priority for synthesis answers about beliefs, theses, or technical opinions — the answer body lives in /wiki/ or /lab/, not /resume. Resume as priority only when the question is itself about employment / experience / hiring (recruiter persona).
- For technical-opinion answers (RAG vs fine-tune, model selection, MCP, latency, agent vs chatbot): priority is the matching theme (wiki/enterprise-ai-reality, wiki/agent-first, wiki/voice-ai-craft) or the relevant lab page (lab/voice-ai-production for voice).
