...
//
// NOTE: `index.html` (landing) uses the SHARED_HEADER_HTML_LANDING variant
// (6 icons, keeps Resume). It is NOT in this list — its chrome:header block
// is updated by hand to keep the 6-icon variant locked. Every other page
// gets the 5-icon SHARED_HEADER_HTML via this script.
//
// `wiki/index.html` was moved to `wiki/themes/index.html` on 2026-04-27
// (graph is now the wiki entry, theme grid moved one level deeper).
const PAGES = [
  '404.html',
  'enter/index.html',
  'resume/index.html',
