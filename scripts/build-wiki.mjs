...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  header.site-header{position:fixed;top:0;left:0;right:0;height:clamp(52px,6vw,64px);z-index:20;padding:0 clamp(1rem,3vw,1.5rem);display:flex;align-items:center;justify-content:space-between;}
  .icon-bar{display:inline-flex;align-items:center;}
  .icon-bar a{color:var(--text-dim);display:inline-flex;align-items:center;justify-content:center;width:2em;height:2em;font-size:clamp(1.15rem,1.3vw,1.5rem);transition:color 0.2s;text-decoration:none;}
  .icon-bar a:hover{color:var(--accent);}
...
<div class="legend-strip">
  ...
  <div style="font-size:9px;opacity:0.5;margin-top:6px;">cp-1..6 ✓ · cp-7 final pass</div>
</div>
...
(function(){
  ...
  // Re-fit on resize: reset to default viewBox
  let resizeTimer;
...
`;
  ...
  writeFileSync(tmp, html);
  renameSync(tmp, out);
  console.log(`[build-wiki] generated graph -> wiki/graph/index.html (${html.length} bytes) [CP-6 pan/zoom/fullscreen]`);
  okCount++;
}
