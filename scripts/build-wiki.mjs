...
const SHARED_HEAD_STYLES = `
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .icon-bar a.nav-icon{font-family:var(--mono);font-size:clamp(0.78rem,0.95vw,0.92rem);font-weight:500;letter-spacing:0.04em;text-transform:uppercase;}
...
const SHARED_HEADER_HTML = `<header class="site-header">
  <div class="icon-bar">
    ...
    <a class="nav-icon" href="/resume" aria-label="CV">CV</a>
