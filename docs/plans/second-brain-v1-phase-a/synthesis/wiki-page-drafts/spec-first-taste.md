...
references:
  - https://www.linkedin.com/posts/agamarora_tried-and-dropped-google-stitch-in-under-30-minutes-activity-7447981735901949952 [2026-04-09, trilogy canonical]
  - https://www.linkedin.com/posts/agamarora_anti-customization-prd-productmanagement-activity-7402319253036531712 [2025-12-04, anti-customization declaration]
  - https://www.linkedin.com/posts/agamarora_product-management-is-the-grind-activity-6938349828124921856 [2022-06-03, 99/1 grind]
  - https://www.linkedin.com/posts/agamarora_product-management-is-a-featherless-hat-activity-6846280835910406144 [2021-09-22, featherless hat]
  - https://www.linkedin.com/posts/agamarora_ai-agents-agentfirst-activity-7341662205257433088 [2025-06-20, agent-first manifesto]
  - https://www.linkedin.com/posts/agamarora_second-brain-context-layer-activity-7452998640345853952 [2026-04-23, second-brain launch]
open_qs_for_taste_pass:
  - (1) Title "builder trilogy" or something more general? Does naming the post structure as the page title feel too self-referential?
  - (2) Anchor on taste-over-execution (timeless) or spec-over-sprint (AI-tool-specific)? Current draft opens with trilogy as composite, then leads body with taste as the through-line.
  - (3) The narrative arc claims taste was "lived since 2021 but named in 2026." Does Agam endorse this - was 2026-04-09 vocabulary upgrade or genuine new realization?
  - (4) Should the ship-fast supersession be named explicitly on this page, or kept to the second-brain/personal-projects theme?
  - (5) Anti-customization cross-link: is the current framing (PM-layer manifestation of the same disposition) accurate, or does Agam see anti-customization as its own separate discipline?
---
...
The 99/1 grind from 2022 is the slow-building form of "Taste > Execution" - both say the discrimination work is the work. Anti-customization cross-links both pages: it lives at PM-craft level (pm-taste primary home) while serving as the most concrete, on-record example of the spec-first-taste disposition in action. Same disposition, two entry-point audiences.

See also: `personal-projects-tinkering` for the ship-the-prototype complement. Spec-first-taste is preparation before shipping, not refusal to ship. Both pages hold.
...
- **(4)** Ship-fast supersession: the spec-over-sprint deep-dive documents a clean pre-LLM / post-LLM iteration-economics flip. Should this page name the flip explicitly ("earlier stance was speed-over-spec; post-LLM, flipped to spec-over-sprint"), or is that detail better held in the second-brain / personal-projects theme?
