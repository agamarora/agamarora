...
references:
  - 2018-02-15 — ICO is a fundraising tool, not a product
  - 2018-03-06 — blockchain "biggest database innovation" canonical
  - 2019-07-11 — never the smartest person in the room
  - 2024-03-31 — Devin not a developer replacement
  - 2025-12-04 — anti-customization declaration
open_qs_for_taste_pass:
  - (1) Should substance-over-hype be explicitly named as "root disposition" on the wiki, or left as implied frame readers infer from theme pages?
  - (2) Co-root with never-be-smartest-in-room — one root page (this draft) or two separate brief pages?
  - (3) Are 5 archetype examples (blockchain to anti-customization) the right span, or should the page front-load only 2024-26 examples?
---
...
**Blockchain, 2018:** "Blockchain is a database innovation first which can be used to improve a lot of processes." Written while running a blockchain startup, which makes it harder to dismiss as outside criticism.

**ICOs, 2018:** "Somewhere in between blockchain and ICO the product is getting lost. ICO is a fund raising tool which helps visionary teams build product for the future." The cleanest archetype: separate the funding mechanism from the product claim.

**Devin, 2024:** "I would catch on to the hype once Devin replaces its founders to build Devin 2.0." A substrate-test in conditional form: withhold belief until the claim proves itself at the level it's actually being made.

**GenAI, 2024:** "Almost everyone believes GenAI is overhyped. Yet there is something magically different from other techs that were hyped and never lived up (I am looking at you Blockchain)." The substrate-test passes here: GenAI radically reduces the cost of cognition. That is genuinely new. The hype is earned this time.
