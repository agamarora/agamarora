...
references:
  - https://www.linkedin.com/posts/agamarora_flutter-dart-prototype-activity-6668609461650784256 [2020-05-19, canonical inversion]
  - https://www.linkedin.com/posts/agamarora_flutter-dart-course-activity-6660250632366239744 [2020-04-26, lockdown capability acquisition]
  - https://www.linkedin.com/posts/agamarora_personal-website-streamlit-activity-7053307873887404032 [2023-04-16, agamarora.com v1 ship]
  - https://www.linkedin.com/posts/agamarora_ollama-llama3-keyboard-activity-7204134749513162752 [2024-06-05, ollama keyboard shortcut]
  - https://www.linkedin.com/posts/agamarora_crewai-autogen-autogpt-activity-7221720797655023616 [2024-07-24, CrewAI/Autogen comparison]
  - https://www.linkedin.com/posts/agamarora_llm-comparator-groq-streamlit-activity-7241688287910752257 [2024-09-17, LLM comparator open-sourced]
  - https://www.linkedin.com/posts/agamarora_second-brain-launch-activity-7452998640345853952 [2026-04-23, second-brain v1 launch]
  - https://www.linkedin.com/posts/agamarora_weekend-ai-projects-activity-7212422529489981442 [2024-06-28, weekend AI project playbook]
crosslinks:
  - projects/index.html: DAG artifact, full 52-project graph
  - linkedin-as-instrument: distribution layer (the "publicly" half)
  - spec-first-taste: refinement of ship-fast, ship the well-spec'd version
open_qs_for_taste_pass:
  - (1) Which 5-7 projects from the 52 to foreground? Current draft: V2 Games, Flutter prototyping, agamarora.com v1, LLM comparator + CrewAI, second-brain v1. Should Shararat (Vapi Build Challenge) replace one?
  - (2) Gaming projects: foreground V2 Games here as E2 origin of gaming-as-economic-intuition, or keep primarily in early-career sub-section of career-reflection?
  - (3) tinker-publicly merge verdict: draft frames publishing as distribution decision (separate from building). If Agam endorses "the loop closes only when I've posted it," framing should shift to loop-closure.
  - (4) AIonOS under-share: draft says "enterprise work intentionally under-shared" without naming AIonOS. Name it explicitly or leave implicit?
  - (5) V2 Games dissolution: draft names the archiving as context for why validation thinking became necessary. Name it directly or soften to "early studio work"?
---
...
Ideas are cheap. The prototype is the argument.

This is not a principle held in the abstract. It is a conclusion from a specific moment: lockdown, 2020, no dev budget, a product idea that needed a mobile app to prove it. Rather than waiting for a team, he pulled up a Flutter/Dart course and built the capability himself. Three weeks later: "No longer 'just an idea!' :)"
...
Not a manifesto. A constraint turned into a capability. A workaround that became a habit.

By 2023, the substrate had shifted: Python and Streamlit for personal-brand work. By 2024: local LLMs via Ollama, then CrewAI agentic orchestration, then Groq-powered comparators. By 2026: vanilla HTML, Claude Code, kg.json. The tools rotated; the pattern did not.

---

## What it implies: the 52-project pattern

The full project lineage is at `projects/index.html`: 52 projects, 41 lineage edges, 58 tech nodes across 10 years. What the DAG shows is not a portfolio. It is a practice.
...
Cross-link: `linkedin-as-instrument`.

---

## Tension with `spec-first-taste`

In 2020: any prototype beats no prototype. Ship even when embarrassed. Reid Hoffman's "if you're not embarrassed by the first version, you launched too late" was borrowed authority.
...
Cross-link: `spec-first-taste` for the builder trilogy (Spec > Sprint / Taste > Execution / Context > Prompt) as refinement, not replacement.
