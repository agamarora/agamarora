...
references:
  - 2023-03-24 ChatGPT plugins post — urn:li:activity:7044971627607900160
  - 2024-06-06 MAS architecture post — urn:li:activity:7204325913650491392
  - 2024-12-24 kill-prompting post — urn:li:activity:7277158028422914048
  - 2025-06-20 agent-first manifesto — urn:li:activity:7341662205257433088
  - 2025-07-17 agents primer — urn:li:activity:7351602695977226243
  - 2025-09-29 production deployment comment — urn:li:activity:7378427141190799360
  - 2025-11-17 threat-actor post — urn:li:activity:7396047657951064064
  - 2026-01-06 reversibility post — urn:li:activity:7414150680820547584
  - 2026-04-09 builder trilogy — urn:li:activity:7447981735901949952
  - 2026-04-23 second-brain launch — urn:li:activity:7452998640345853952
open_qs_for_taste_pass:
  - Should kill-prompting appear as an explicit named waypoint in the craft section, or only as a suppressed historical footnote?
  - Does application-layer-is-where-safety-lives belong here or should it anchor a separate cross-theme sidebar?
  - Is the serving-lens framing still how Agam would lead this page in 2026, or has the craft posture overtaken the strategic frame?
  - How strongly to weight the "(and maybe first)" parenthetical — mild or radical reading?
  - The 2025-09-29 voice-AI comment is the densest practitioner evidence. Preferred framing: cite as voice-AI directly, or paraphrase as "MCP-first agent deployment"?
---
...
The tension with `reversibility-over-consequences` is structural and held, not resolved. Orchestration scope and authorization scope are different axes. Bullish on deployment. Bearish on decision authority without programmatic evaluability. The 2026-01-06 post holds both: "Not just guardrails, but checks and balances." Deployment scope and authorization scope are not the same dial.
...
>
> 1. **kill-prompting visibility:** The 2024-12-24 U-turn post is on the public record and the refinement arc is honest. Should it appear as a named waypoint in the craft section ("I said this, then refined it"), or as a suppressed historical footnote?
>
> 2. **application-layer-safety placement:** This page carries all three safety beliefs nested under "What it implies." Should they stay here, or should one anchor a separate cross-theme safety page?
>
> 3. **serving-lens vs craft as lead:** The 2025-06-20 manifesto leads with the serving lens (platform readiness). By 2026-04-09 it has become craft posture (context > prompt). Does Agam want the page to open with the 2025 strategic frame and trace forward, or lead with current-voice (craft) and trace backward?
>
