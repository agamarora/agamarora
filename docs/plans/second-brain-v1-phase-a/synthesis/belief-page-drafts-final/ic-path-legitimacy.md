...
IC-path legitimacy is an operator economics principle. AI-era ICs who have invested in agent fluency, spec discipline, and taste compound their judgment advantage faster than the org chart grows. The PM who spent twelve years going deep on product judgment, enterprise AI architecture, and open-source contribution has a skill profile that a management track would have diluted. A $1M ARR inside 18 months at FarEye and a 60-day-to-7-day data onboarding compression: both were IC contributions. No headcount required to measure either one. Craft compounds. Span of control is one measure of career progress. It is not the only one, and in the AI era it is increasingly not the most durable one.
