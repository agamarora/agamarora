...
Cross-link: [`career-reflection`](/wiki/career-reflection/) for the learning method (learn-concepts-not-tools) and [`ai-pm-skillset`](/wiki/ai-pm-skillset/) for the T-shape domain choice and application-layer depth.
