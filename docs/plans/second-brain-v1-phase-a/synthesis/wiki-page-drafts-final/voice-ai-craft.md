...
positioning: satellite_to_enterprise_ai_reality
beliefs:
...
Secondary cross-link: [`enterprise-ai-reality`](/wiki/enterprise-ai-reality/) — where the voice-AI production reply appears as a worked example in the evidence section, and where the satellite relationship of this theme lives.
